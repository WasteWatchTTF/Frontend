    ...
    >
      ...
      <Box
        sx={{
          ...
          borderRadius: '50%',
          background: darkMode
            ? 'radial-gradient(circle, rgba(46, 125, 50, 0.05) 0%, transparent 60%)'
            : 'radial-gradient(circle, rgba(46, 125, 50, 0.1) 0%, transparent 60%)',
        ...
        <Fade in={true} timeout={800}>
          ...
          >
            ...
            >
              ...
              >
                Crea il tuo account e inizia il tuo viaggio verso un futuro più verde e sostenibile
              </Typography>
            </Box>
